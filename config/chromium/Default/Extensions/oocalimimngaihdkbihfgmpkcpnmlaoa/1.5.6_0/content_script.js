...
(function() {
  ...
  if (!window.netflixPartyLoaded) {
	...
	if (!npServerIdFromUrl) {
		// default server
		socket = io('https://' + 's2' + '.netflixparty.com/', corsOptions);
		console.log('socket: https://' + 's2' + '.netflixparty.com/');	
        ...
        return new Promise(function(resolve, reject) {
			...
			chrome.storage.local.get(null, function(data) {
				...
				if(data.userId && data.userIcon) {
					...
					userSettings = {'userId': userId, 'userIcon': newIcon};
    ...
    chatHtml2 = `
      <style>
        @import url("https://fonts.googleapis.com/css?family=Poppins:400,400i,500,500i,600,700,800");
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #title {
          height: 100%;
          display: flex;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #title h1 {
          margin: 0em;
          font-size: 1em;
          font-weight: 700;
          color: #ff3333;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #user-icon {
          display: flex;
          align-items: center;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #user-icon img {
          width: 40px;
        }

        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #link-icon {
          display: flex;
          align-items: center;
          justify-content: flex-end;
          height: 100%;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #link-icon:hover {
		  opacity: 1;
		  transform: scale(1.1);
		}

		 #chat-wrapper #chat-container #chat-header-container #chat-menu-container #link-icon:active {
		  opacity: 0.5;
		  color: green;
		  transform: scale(0.9);
		}
        
        #chat-wrapper #chat-container #chat-header-container #chat-menu-container #link-icon img {
          width: 1.3em;
        }
        
        #chat-wrapper #chat-container #chat-header-container #chat-link-container {
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-link-container #chat-link {
          display: flex;
          align-items: center;
          background: black;
          height: 30px;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-link-container #chat-link #chat-link-url {
          display: flex;
          flex-flow: column;
          justify-content: center;
          padding-left: 10px;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-link-container #chat-link #chat-link-url p {
          color: white;
          font-size: 0.7em;
          font-weight: 500;
          color: #b3b3b3;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-link-container #chat-link #chat-link-icon {
          width: 60px;
          height: 100%;
          text-align: center;
          display: flex;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-link-container #chat-link #chat-link-icon img {
          position: relative;
          margin: 0 auto;
          width: 15px;
          height: 15px;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container {
          width: 228px;
          top: 80px;
        }
        
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-title-container {
          display: flex;
          flex-flow: wrap row;
          align-items: center;
          height: 35px;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-title-container #icon-title {
          
          width: 70%;
        }
        
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-title-container #icon-title h2 {
          margin: 0em;
          padding-left: 10px;
          font-size: 0.8em;
          font-weight: 700;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-title-container #icon-exit {
          width: calc(30% - 15px);
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-title-container #icon-exit img {
          width: 16px;
        }
        
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-holder-container {
          width: 100%;
          height: 220px;
          display: flex;
          justify-content: center;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-holder-container #icon-holder-template {
          width: 100%;
          height: 180px;
          width: 228px;
        }
        
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-holder-container #icon-holder-template #icon-holder {
          display: flex;
          flex-flow: wrap row;
          list-style: none;
          padding: 0em;
        ...
        #chat-wrapper #chat-container #chat-header-container #chat-icon-container #icon-holder-container #icon-holder-template #icon-holder a {
          width: 40px;
          padding: 1.4px 2.8px;
        }
        
        #chat-wrapper #chat-container #chat-history-container {
          position: absolute;
          width: 228px;
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history {
          position: absolute;
          width: 228px;
          bottom: 0;
          overflow:  auto;
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history .msg {
          /*display: block;*/
          display:flex;
          align-items: center;
          /*height: 40px;*/
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history .msg .icon {
          width: 30px;
          height: 30px;
          padding-top:5px;
          padding-bottom:5px;
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history .msg .message-system p {
          // font-size: 0.8em;
          font-size: 1em;
          font-weight: 500;
          color: #4d4d4d;
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history .msg .message-txt p {
          /* font-size: 0.8em; */
          font-size: 1em;
          font-weight: 500;
          color: #cccccc;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container {
		  width: 100%;
		}
		/* line 201, ../sass/style.scss */
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .icon-name {
		  width: 100%;
		  display: flex;
		  flex-flow: wrap row;
		  align-items: center;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .icon-name .icon {
		    width: 30px;
		    height: 30px;
		    padding-top: 5px;
		    padding-bottom: 5px;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .icon-name .icon img {
		  width: 100%;
		  height: 100%;
		}
		/* line 214, ../sass/style.scss */
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .icon-name h3 {
		    font-size: 1em;
		    font-weight: 600;
		    color: #c3c3c3;
		    font-family: 'Poppins', sans-serif;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .msg-txt {
		  padding-left: 50px;
		  padding-right: 5px;
		  margin-left: 5px;
		  margin-bottom: 1em;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .msg-txt p {
		  font-family: 'Poppins', sans-serif;
		  font-size: 0.9em;
		  font-weight: 500;
		  color: #b2b3b3;
		...
		#chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .message-system p {
		  font-size: 0.9em;
          font-weight: 500;
          color: #4d4d4d;
          font-style: italic;
        ...
        #chat-wrapper #chat-container #chat-history-container #chat-history .msg-container .message-txt p {
          /* font-size: 0.8em; */
		  font-size: 0.9em;
          font-weight: 500;
          color: #cccccc;
        ...
        #chat-wrapper #chat-container #presence-indicator {
          position: absolute;
          height: 25px;
          width: 228px;
          bottom: 105px;
        ...
        #chat-wrapper #chat-container #presence-indicator p {
          margin: 0em;
          /* font-size: 0.8em; */
          font-size: 12.8px;
          font-weight: 400;
        ...
        #chat-wrapper #chat-container #chat-input-container {
          position: absolute;
          width: 228px;
          left: 0px;
          right: 0px;
        ...
        #chat-wrapper #chat-container #chat-input-container #chat-input {
          display: block;
          height: 35px;
          line-height: 25px;
          width: calc(100% - 10px);
        ...
        #chat-wrapper #chat-container #chat-input-container #chat-input::placeholder {
        	color: white;
        	opacity: 0.8;
        }


		#chat-wrapper #chat-container .chat-settings-container .section-b {
		  width: 100%;
		  margin-bottom: 1.5em;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-b .section-b-inner {
		  display: flex;
		  flex-flow: column;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-b .section-b-inner .user-icon {
		  width: 100%;
		  text-align: center;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-b .section-b-inner .user-icon img {
		  width: 85px;
		  height: 85px;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c {
		  height: 100%;
		  position: relative;
		  display: flex;
		  flex-flow: column;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner {
		  display: flex;
		  flex-flow: column;
		  position: relative;
		  height: 100%;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap {
		  width: 100%;
		  margin-bottom: 1.8em;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one {
		  display: flex;
		  flex-flow: wrap row;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one h2 {
		  width: 65%;
		  font-family: 'Poppins', sans-serif;
		  font-size: 1em;
		  font-weight: 600;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one .np-btn {
		  width: 35%;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one .np-btn a {
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one .np-btn a p {
		  font-family: 'Poppins', sans-serif;
		  font-size: 0.9em;
		  font-weight: 500;
		  color: #b2b3b3;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one .np-btn a img {
		  width: 18px;
		  height: 18px;
		  padding-left: 0.4em;
		  transform: scale(0.9);
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-one .np-btn a img:hover {
		  transform: scale(1);
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .row-wrap .row-two p {
		  font-family: 'Poppins', sans-serif;
		  font-size: 0.9em;
		  font-weight: 500;
		  color: #b2b3b3;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap {
		  width: 100%;
		  margin-bottom: 1.8em;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-one h2 {
		  font-family: 'Poppins', sans-serif;
		  font-size: 1em;
		  font-weight: 600;
		  color: #c3c3c3;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two {
		  display: flex;
		  flex-flow: wrap row;
		  justify-content: space-between;
		  align-items: center;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two p {
		  width: 60%;
		  font-family: 'Poppins', sans-serif;
		  font-size: 0.85em;
		  font-weight: 500;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .switch {
		  position: relative;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .switch input {
		  opacity: 0;
		  width: 0;
		  height: 0;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .slider {
		  position: absolute;
		  cursor: pointer;
		  top: 0;
		  left: 0;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .slider:before {
		  position: absolute;
		  content: "";
		  height: 20px;
		  width: 20px;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two input:checked + .slider {
		  background-color: #000000;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two input:focus + .slider {
		  box-shadow: 0 0 1px #000000;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two input:checked + .slider:before {
		  -webkit-transform: translateX(20px);
		  -ms-transform: translateX(20px);
		  transform: translateX(20px);
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .slider.round {
		  border-radius: 34px;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .enable-wrap .enable-two .slider.round:before {
		  border-radius: 50%;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .nickname-input {
		  width: 100%;
		  z-index: 9999999999;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .nickname-input input {
		  width: 100%;
		  font-family: 'Poppins', sans-serif;
		  font-size: 1em;
		  font-weight: 500;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .nickname-input input:focus {
		  border-bottom-color: 1px solid red;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .party-link {
		  width: 248px;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-c .section-c-inner .party-link p {
		  overflow: hidden;
		  height: 16px;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-d {
		  width: 100%;
		}

		#chat-wrapper #chat-container .chat-settings-container .section-d .section-d-inner {
		  height: 85px;
		  padding-bottom: 60px;
		  margin-top: 10px;
		  border-radius: 12px;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-d .section-d-inner .btns {
		  width: 100%;
		  height: 100%;
		  display: flex;
		  flex-flow: column;
		...
		#chat-wrapper #chat-container .chat-settings-container .section-d .section-d-inner .btns button {
		  padding: 0.8em 0em;
		  width: 100%;
		  border-radius: 50px;
		  border: none;
		  ...
		  -moz-filter: drop-shadow(0px 4px 4px #000000);
		}

		#chat-wrapper #chat-container .chat-settings-container .section-d .section-d-inner .btns button:hover {
		  background: #b969a9;
		  ...
		  -webkit-filter: drop-shadow(0px 3px 11px #000000);
		  -moz-filter: drop-shadow(0px 3px 11px #000000);
		  color: White;
      ...
      <div id="chat-wrapper">
        <div id="chat-container">
          ...
          <div id="chat-header-container">
			...
			<div class="chat-settings-container" style="display:none">
		          ...
		          <div class="section-c-inner section-inner">
		            <div class="nickname-section row-wrap">
		              ...
		              <div class="nickname-input row-two">
		                <input type="text" placeholder='${userSettings.userNickname ? userSettings.userNickname : "Add a nickname"}'/>
		              </div>
		            </div>
		          </div>
		        </div>
            ...
            <div id="chat-icon-container" style="display:none">
              <div id="icon-title-container">
                ...
                <div id="icon-exit">
                  <img src='${chrome.runtime.getURL("img/Exit-Unhover.svg")}'>
                </div>
              </div>
          ...
          <div id="chat-input-container">
            <input id="chat-input" placeholder="Type a message..." autocomplete="off"></input>
          </div>
        </div>
      </div>
    `;
    ...
    var initChat = function() {
      if (jQuery('#chat-wrapper').length === 0) {
	    ...
	    var linkIconListener = function(e) {
	      ...
	      var serverId = getURLParameter(url, 'npSessionId', 1) ? getURLParameter(url, 'npSessionId', 1) : defaultServer;
		  ...
		  var message = jQuery(`
	        <div class="msg">
	          ...
	          <div class="message${ message.isSystemMessage ? '-system' : '-txt' }">
	            <p class="msg-nickname">${userNickname}</p>
	            <p>${message.body.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}</p>
	          </div>
	        </div>
